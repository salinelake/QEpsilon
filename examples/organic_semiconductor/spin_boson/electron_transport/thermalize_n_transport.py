...
for idx in range(nq):
    ...
    system.add_operator_group_to_hamiltonian(sz2)
    ...
    system.add_operator_group_to_hamiltonian(sz3)
    ...
    # sz_jump = qe.StaticPauliOperatorGroup(n_qubits=nq, id="sz_jump_{}".format(idx), batchsize=batchsize, coef=1.0, requires_grad=False)

    sz_jump.add_operator(seq)
    system.add_operator_group_to_jumping(sz_jump)
