...
axial_temperature = 2e-05 # K, note that 100uK temperature is at full tweezer depth, so actual thermal temp is 50uK?
radial_temperature = 1e-05 # K, note that 100uK temperature is at full tweezer depth, so actual thermal temp is 50uK?
tau = 1000000 # us
