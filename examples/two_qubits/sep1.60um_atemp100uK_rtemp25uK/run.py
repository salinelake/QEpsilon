...
axial_temperature = 0.0001 # K, note that 100uK temperature is at full tweezer depth, so actual thermal temp is 50uK?
radial_temperature = 2.5e-05 # K, note that 100uK temperature is at full tweezer depth, so actual thermal temp is 50uK?
