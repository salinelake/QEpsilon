...
axial_temperature = 7.2e-05 # K, note that 100uK temperature is at full tweezer depth, so actual thermal temp is 50uK?
radial_temperature = 5.4e-05 # K, note that 100uK temperature is at full tweezer depth, so actual thermal temp is 50uK?
